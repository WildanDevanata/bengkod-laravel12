...
class AdminController extends Controller
{
    ...
    public function showUsers($role)
    {
        try {
            ...
            if ($roleName == 'dokter') {
                return view('admin.dokter', compact('users','polis'));
    ...
    public function createUser(Request $request)
    {
        try {
            ...
            if ($validatedData['role'] == 'pasien') {
                return redirect()->route('admin.pasien')->with('success', 'User successfully created.');
            } elseif ($validatedData['role'] == 'dokter') {
                return redirect()->route('admin.dokter')->with('success', 'User successfully created.');
            } else {
    ...
    public function getUser($id)
    {
        try {
            ...
            if ($user->role == 'dokter') {
                return view('admin.dokter_edit', compact('user','polis'));
            } elseif ($user->role == 'pasien') {
                return view('admin.pasien_edit', compact('user'));
            } else {
    ...
    public function editPoli($id)
    {
        try {
            ...
            return view('admin.poli_edit', compact('poli'));
