...
{
    public function MasihBelumdiPeriksa()
{
    // Get the ID of the currently logged-in doctor
    $id_dokter = Auth::user()->id;

    // Ambil janji periksa yang belum dilakukan pemeriksaan oleh dokter ini
    ...
    public function editPeriksa($id)
    {
        ...
        return view('dokter.periksa_edit', compact('janjiPeriksa', 'obatList'));
    }
    ...
    public function memeriksaPasien(Request $request, $id)
    {
        ...
        if ($janjiPeriksa->periksa) {
            return redirect()->route('dokter.Periksa')->with('error', 'Pasien sudah diperiksa.');
        }
        ...
        try {
            ...
            return redirect()->route('dokter.periksa')->with('error', 'Terjadi kesalahan saat menyimpan pemeriksaan.');
        }
    }
    ...
    public function deleteJanjiPeriksa($id)
    {
        ...
        // Pastikan janji periksa belum diperiksa
        if ($janjiPeriksa->periksa) {
            return redirect()->route('dokter.periksa')->with('error', 'Tidak dapat menolak, pasien sudah diperiksa.');
        }
        ...
        try {
            ...
            return redirect()->route('dokter.periksa')->with('success', 'Janji periksa berhasil ditolak.');

        } catch (\Exception $e) {
            Log::error("Error rejecting janji periksa: " . $e->getMessage());
            return redirect()->route('dokter.periksa')->with('error', 'Terjadi kesalahan saat menolak janji periksa.');
        }
    }
    ...
    public function getProfile($id)
    {
        ...
        return view('dokter.dashboard_edit', compact('user'));
    }
    ...
    public function editJadwal($id)
    {
        ...
        return view('dokter.jadwalperiksa_edit', compact('jadwal', 'activeSchedule'));
    }
...
//        dd($periksas);
        ...
        return view('dokter.history', compact('periksas'));
    }
