    ...
    <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <table class="table table-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $periksa->janjiPeriksa->jadwalPeriksa->dokter->name ?? 'Dokter tidak ditemukan' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><strong>Biaya:</strong></td>
                                                <td><strong class="text-success">Rp
                                                        {{ number_format($periksa->biaya_periksa, 0, ',', '.') }}</strong></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="col-md-6">
        ...
        @else
            ...
            <div class="text-center py-5">
                ...
                <p class="text-muted">Anda belum memiliki riwayat pemeriksaan. Silakan buat janji periksa terlebih dahulu.
                </p>
                <a href="{{ route('pasien.janjiPeriksa') }}" class="btn btn-primary">
...
@section('css')
<link rel="stylesheet" href="{{ asset('vendor/lte/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css') }}">
<link rel="stylesheet" href="{{ asset('vendor/lte/plugins/datatables-responsive/css/responsive.bootstrap4.min.css') }}">
<style>
    .modal-lg {
        max-width: 900px;
    }
