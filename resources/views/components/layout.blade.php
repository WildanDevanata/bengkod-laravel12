    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link d-flex align-items-center">
                <img src="{{ asset(path: 'lte/dist/img/Logo-Udinus-Official-02-300x300-1.png') }}" alt="Logo"
                    class="brand-image img-circle elevation-3" style="opacity: .8; width: 35px; height: 35px;">
                <span class="brand-text font-weight-light ms-2">Poliklinik BK</span>
            </a>
